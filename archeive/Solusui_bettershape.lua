...
local ms_classes = {
		...
		local g_paint_handler = function()
			...
			note.get(function(id)
				...
				if ui_get(ms_palette) == menu_palette[1] then
					m_render_engine.render_container(x, y, w, 22, r, g, b, a)
				else
					m_render_engine.render_container(x, y, w, 22, r, g, b, a)
				...
				--renderer.blur(x, y + 2, w, h, 17, 17, 17, a)
	...
	spectators = function()
		...
		local g_paint_handler = function()
			...
			if ui_get(ms_palette) == menu_palette[1] then
				--m_render_engine.render_container(x, y, w, h, r, g, b, m_alpha*255)
			else
				--m_render_engine.render_container(x, y, w, h, r, g, b, m_alpha*255)
			end
